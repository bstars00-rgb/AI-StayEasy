...
export const searchStrings: Record<Lang, SearchStrings> = {
  en: {
    ...
    reason: {
      ...
      budget: 'Good value', firsttime: 'Easy for first-timers', hoian: 'Hoi An', danang: 'Da Nang', hcmc: 'Ho Chi Minh City', nhatrang: 'Nha Trang', phuquoc: 'Phu Quoc', hanoi: 'Hanoi', hue: 'Hue',
    },
  },
  ko: {
    nav: 'AI 검색',
    ...
    reason: {
      ...
      budget: '가성비 좋음', firsttime: '첫 방문에 편리', hoian: '호이안', danang: '다낭', hcmc: '호치민', nhatrang: '냐짱', phuquoc: '푸꾸옥', hanoi: '하노이', hue: '후에',
    },
  },
  vi: {
    nav: 'Tìm kiếm AI',
    ...
    reason: {
      ...
      budget: 'Giá trị tốt', firsttime: 'Dễ cho người lần đầu', hoian: 'Hội An', danang: 'Đà Nẵng', hcmc: 'TP. Hồ Chí Minh', nhatrang: 'Nha Trang', phuquoc: 'Phú Quốc', hanoi: 'Hà Nội', hue: 'Huế',
    },
  },
  zh: {
    nav: 'AI 搜索',
    ...
    reason: {
      ...
      budget: '高性价比', firsttime: '适合初次到访', hoian: '会安', danang: '岘港', hcmc: '胡志明市', nhatrang: '芽庄', phuquoc: '富国岛', hanoi: '河内', hue: '顺化',
    },
  },
  ja: {
    nav: 'AI検索',
    ...
    reason: {
      ...
      budget: 'コスパ良好', firsttime: '初訪問に便利', hoian: 'ホイアン', danang: 'ダナン', hcmc: 'ホーチミン', nhatrang: 'ニャチャン', phuquoc: 'フーコック', hanoi: 'ハノイ', hue: 'フエ',
    },
  },
}
